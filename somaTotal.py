...
lista_lfacil = open(r"C:\testearquivos\salvaPorPosicao051020201646.txt")
...
def comparar(p_combinacoes):
    ...
    for i in range(len(combinacoes)):
        ...
        if ((somaTotal > 166 ) & (somaTotal < 211 )):
            with open(r"C:\testearquivos\somaTotal071020200911.txt", "a") as val:
                print(cont03)
