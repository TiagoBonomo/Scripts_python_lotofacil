...
lista_lfacil = open(r"C:\testearquivos\somaTotal210920201003.txt")
...
def comparar(p_combinacoes):
    ...
    for i in range(len(combinacoes)):
        ...
        if ((somaUnidade > 50) & (somaUnidade < 75)):
            with open(r"C:\testearquivos\somaUnidade071020200916.txt", "a") as val:
                print(cont03)
